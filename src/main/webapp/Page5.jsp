...
<option value="14" <% if("14".equals(birthday3)){ %> selected<%} %>>13</option>
<option value="15" <% if("15".equals(birthday3)){ %> selected<%} %>>13</option>
<option value="16" <% if("16".equals(birthday3)){ %> selected<%} %>>13</option>
<option value="17" <% if("17".equals(birthday3)){ %> selected<%} %>>13</option>
<option value="18" <% if("18".equals(birthday3)){ %> selected<%} %>>13</option>
<option value="19" <% if("19".equals(birthday3)){ %> selected<%} %>>13</option>
<option value="20" <% if("20".equals(birthday3)){ %> selected<%} %>>13</option>
